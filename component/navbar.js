let nav__bar = ()=>{
    return `
            ...
            <ul class="navbar_nav">
            <li class="navbar_ul_li"><a href='#' style="color:#1b1b20">Features</a></li>
            <li class="navbar_ul_li"><a href='#' style="color:#1b1b20">Pricing</a></li>
            <li class="navbar_ul_li"><a href='#' style="color:#1b1b20">Integration</a></li>
            <li class="navbar_ul_li"><a href='#' style="color:#1b1b20">Blog</a></li>
            </ul>
            <ul class="navbar_nav">
